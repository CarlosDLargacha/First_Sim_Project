...
def simulate_system1(simulation_time):
    ...
    def truck_process(env, truck, service_station, results):
        ...
        with service_station.request() as request:
            ...
            service_time = np.random.exponential(1/SERVICE_RATE_SYSTEM1)
    ...
    logger.info(f"Simulación Sistema 1 completada. Camiones procesados: {metrics['trucks_processed']}")
    return metrics
